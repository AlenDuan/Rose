...
{
public:
	tprogress(display& disp, const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel, int best_width, int best_height);
	~tprogress();
