...
tchat_::tchat_(display& disp, const std::string& widget_id, int chat_page)
...
tchat2::tchat2(display& disp, const std::string& widget_id)
	: tchat_(*display::get_singleton(), widget_id, CHAT_PAGE)
