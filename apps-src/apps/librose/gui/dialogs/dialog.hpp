...
public:
	 ...
	 */
	bool show(CVideo& video, const unsigned explicit_x = nposm, const unsigned explicit_y = nposm);
...
bool run_with_progress(display& disp, const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel, const SDL_Rect& rect = SDL_Rect{nposm, nposm, nposm, nposm});
